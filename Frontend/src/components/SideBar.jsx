            ...
            <div className='SideBardList'>
                <Link to={'/dashboard'}>
                    <div className='SideBarTarget'>
                        <DynamicIcon name={'layout-dashboard'} size={22} color='#535050' />
                        <p>Dashboard</p>
                    </div>
                </Link>
                {
                    menu.map((item) => (
                        <SideBarTarget key={item.target} Target={item.target} icon={item.icon} />
                    ))
                }
                {/* <div className='SideBarTarget' onClick={logout}>
                    <DynamicIcon name={'log-out'} size={22} color='#535050' />
                    <p>Cerrar Sesion</p>
                </div> */}
